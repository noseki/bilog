...
- Framework: React 19
- ライブラリ： React Router Dom v7, React Hook Form v7, Zod v4, Tanstack Query v5、recharts v3
...
ルート: `/login`, `/signup`, `/reset-password`, `/update-password`, `/home`, `/log-timeline`, `/manage-budget`
