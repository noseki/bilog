...
import { CATEGORY_COLOR, CATEGORY_LABEL } from "@/features/log/utils/log";
...
import { useDeleteLog, useFetchLog } from "../hooks/useLogs";
      ...
      <Card className="relative mx-auto my-2 w-full max-w-sm pt-0">
        <CardContent className="pt-4 pb-6 px-4 space-y-4">
          ...
          <div className="flex items-center justify-between gap-2">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                <DropdownMenuGroup>
                  <DropdownMenuItem
                    onClick={() => navigate(`/log-timeline/${id}/edit`)}
                  >
                    <PencilIcon />
                    編集する
                  </DropdownMenuItem>
          ...
          {log.next_interval_days != null && (
            <p className="text-sm text-muted-foreground">
              次回目安：{log.next_interval_days}日後
            </p>
          )}
        </CardContent>
      </Card>
