...
// import { Controller, useForm, type Control, type UseFormTrigger } from "react-hook-form";
...
// import { useCreateLog } from "./useLogs";
...
//     // 画像のURLを取得
//     const { data, error: urlError } = await supabase.storage.from('images').createSignedUrl(filePath, 600);
//     if (urlError) throw new Error(`画像URL取得失敗 (${prefix}): ${urlError.message}`);
//     return data.signedUrl;
// }

// type LogFormProps = {
//     control: Control<LogValues>;
//     trigger: UseFormTrigger<LogValues>;
...
//                     : Promise.resolve(null),
//             ]);
//             // mutateAsync()はasync/await形式　try/catchでエラーハンドリングしたいのでmutateAsync()使用
